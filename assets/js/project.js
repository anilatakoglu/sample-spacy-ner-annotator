...
$( ".classes" ).on("click",".class",function(){
	...
	//var text_anil = document.getElementById(editor);
	
	selected_text = selection.toString();
	console.log('selected text value : ', selected_text)
	
	//selected_text_id = selection.getSelectionParentElement();
	//console.log('selected text id value : ', selected_text_id)
	
	if(selected_text == ""){
		alert("Please select atleast one entity");
		return;
	}
	console.log('full text value : ', full_text)
	...
	priorRange.selectNodeContents(mainDiv);  //element
	...
	//iniidx =selection.anchorOffset;
	iniidx = start;
	
	console.log('index value : ', iniidx)
...
$( "#entity" ).on("dblclick",".entityval",function(){
	...
	//
	console.log('silinecek text : ', delete_text)
	var e_v_idx = entities_values.indexOf(delete_text);
	//
	console.log('entities_values : ', entities_values)
	console.log('silinecek index : ', e_v_idx)
	...
	//console.log('silinecek index : ', en_del_idx)
